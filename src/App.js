                ...
                <Router>
                    <Dialog open={isOpen} >
                        <div style={{padding:30}}>
                            ...
                            <p>This site is just a prototype. If interested, please share with us your ideal <NavLink onClick={() => closeWarning(false)} to={"/rally/templates"} >meeting template</NavLink> </p>
                            <p>To subscribe, visit the current live site <a href="https://democrasee.club" target="_blank">Democrasee.club</a>.</p>
                        </div>
                    </Dialog>
